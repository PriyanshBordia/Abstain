"""
Django settings for abstain project.
...
WSGI_APPLICATION = 'abstain.wsgi.application'
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
DEFAULT_FROM_EMAIL = 'Team {To Not TODO} <no-reply@tonottodo.io>'
